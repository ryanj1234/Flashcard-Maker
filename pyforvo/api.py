...
class Forvo(object):
    ...
    def pronunciations(self, word, language=None, standard=False):
        ...
        pronunciations = []
        try:
            self._last_response = urllib.request.urlopen(url).read()
            results = json.loads(self._last_response.decode('utf-8'))
...
class Pronunciation(object):
    ...
    def download(self, file_name=None, format=None):
        ...
        with open(file_name, 'wb') as f:
            f.write(urllib.request.urlopen(self.pathmp3).read())
